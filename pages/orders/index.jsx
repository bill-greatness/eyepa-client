...
export default function Orders() {
  ...
  return (
    <div className="w-screen h-screen flex flex-col overflow-hidden overflow-y-auto">
      <Header
        title={"Your Orders"}
        description={"Find status of your orders on Eyepa Foods"}
      />
      <div className="border-b pb-3 px-5 md:px-0">
        <div className="container mx-auto flex items-center space-y-5 md:space-y-0 flex-col md:flex-row md:space-x-10 ">
          <div className="flex items-center space-x-3 md:w-1/4 justify-between w-full">
            <div
              onClick={() => setShowDateSortModal(true)}
      ...
      {showDateSortModal && (
        <div
          onClick={() => setShowDateSortModal(false)}
          className="bg-black/20 flex absolute top-0 left-0 bottom-0 right-0"
        >
          <div className="flex container mx-auto flex-1 relative">
            <div
              ...
              className="bg-white w-60 ml-5 md:ml-0 min-h-40 transition-all flex flex-col rounded-md absolute top-40 p-5 space-y-3 overflow-hidden"
            >
              {dateFilters.map((data, index) => (
                <p
                  ...
                  className=" text-gray-600 transition-all cursor-pointer hover:bg-gray-100 hover:p-2 hover:rounded-md"
                  key={index}
                >
                  {data}
                </p>
