            ...
            <div className="flex flex-col flex-1 container mx-auto space-y-5 py-10">
                ...
                <div className=" min-h-72 md:w-3/4 mx-auto">
                    <div className="border-b py-5 flex flex-row items-center justify-between md:px-5">
                        <p className="text-lg font-semibold">Order A89834GW90</p>
                        <div>
                    ...
                    <p className="text-lg font-light text-gray-500 text-center pt-10">Order Progress</p>
                    ...
                    <div className="flex flex-row items-center justify-center py-10 space-x-5">
                        <div className='flex flex-col space-y-1'>
                            ...
                            <p className='text-sm font-light text-center text-yellow-600'>Preparing</p>
                        </div>
                ...
                <div className='flex flex-col space-y-10'>
                    <div className='flex flex-col space-y-1 items-center justify-center'>
                        ...
                        <h3 className='text-xl font-medium'>{order.estimatedTime}</h3>
                    </div>
                    <div className="md:w-2/5 md:border mx-auto min-h-10 p-5">
                        <div className="flex flex-row items-center space-x-5">
                            <img className="h-20 w-20 rounded-full" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=2960&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                            <div className='flex flex-col space-y-1'>
                ...
                <div className="bg-gray-50 min-h-72 border-t md:w-3/4 mx-auto flex flex-col p-5 space-y-5">
                    <h4 className='text-green-600 font-medium text-sm'>Order Details</h4>
                    {
                        order.products.map((product, index) =>
                            <div className="flex flex-col space-y-5" key={`store-${index}`} >
                                <h3 className='text-lg font-medium'>{product.store}</h3>
                                <div className='flex flex-col space-y-5 px-3'>
                                    {
                                        product.items.map((data, index) => <div key={`item-${index}`}>
                                            <div>
                    ...
                    <div className="flex flex-col space-y-1">
                        <h4 className='text-green-600 font-medium text-sm'>Delivery Location</h4>
                        <p className='text-lg mx-3'>{order.destination}</p>
                    </div>
