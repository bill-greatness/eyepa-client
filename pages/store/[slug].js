...
const comments = [
  ...
  },
  {
    ...
    date: "2 years ago",
    message:
      "Food was delivered on time right temperature and was not missing anything extra requestd....",
  },
];
    ...
    <div className="w-screen h-screen bg-white overflow-hidden overflow-y-auto">
      ...
      <div className="container mx-auto">
        <div className="py-10 flex flex-col space-y-2 px-5 md:px-0">
          <h1 className="text-3xl font-medium text-gray-700">{store?.name}</h1>
          ...
          <div className="flex items-center justify-between py-5">
            <button
              onClick={() => setOpenSimilar((prev) => !prev)}
              className="flex items-center transition-all delay-150 space-x-2 justify-center bg-gray-200 px-3 py-2 rounded-full text-sm"
            >
              <p>See similar </p>
            ...
            <div className="flex items-center bg-gray-100 p-1 rounded-full text-base text-gray-500 overflow-hidden">
              <button
                ...
                className={`px-5 py-2 ${
                  deliveryMode && "bg-white rounded-full"
                }`}
              >
                Delivery
              </button>
      ...
      <div className="flex flex-row items-center space-x-5 overflow-hidden overflow-x-auto">
        {comments.map((comment, index) => (
          <div
            key={`comment-${index}`}
            className="w-2/3 md:w-1/4 flex flex-col h-32 space-y-3 cursor-pointer shrink-0 border  rounded-md p-5"
          >
              ...
              <div className="md:h-40 border-b md:border md:rounded-lg  flex items-center overflow-hidden">
                <div className="flex-1 h-full p-5 flex flex-col space-y-2 overflow-hidden">
                  ...
                  <p className="text-sm font-light text-gray-400 ">
                    Bite-sized pieces of tender all breast meat chicken,
                ...
                <div className="h-24 w-24 md:h-40 bg-gray-100 md:w-40 flex relative overflow-hidden">
                  ...
                  <button
                    ...
                    className="hidden bg-white p-2 rounded-full md:flex absolute bottom-2 shadow-sm border-gray-100 right-2"
                  >
                    <IoAdd size={30} />
                  </button>
                  <button
                    ...
                    className="md:hidden bg-white p-2 rounded-full flex absolute bottom-2 shadow-sm border-gray-100 right-2"
                  >
                    <IoAdd size={18} />
                  </button>
                </div>
