...
export default function Footer() {
    ...
    useEffect(() => {
        setLocation(localStorage.getItem("address"))
    },[])
  return (
      ...
      <div className="container mx-auto flex py-10 flex-col space-y-10 md:space-y-0 md:flex-row px-5 md:px-0">
        <div className="md:w-1/4 flex flex-col space-y-3">
          ...
          <div className="flex flex-col space-y-2">
            <a
              className="hover:text-green-600 text-lg md:text-base w-2/3 text-gray-500 "
              href="#"
            >
             {location}
            </a>
        ...
        <div className="md:w-1/4 flex flex-col space-y-3">
          ...
          <div className="flex flex-col space-y-2 text-gray-400 font-light">
            <a className="hover:text-green-600 text-lg md:text-sm" href="#">
              All Countries
            </a>
            <a className="hover:text-green-600 text-lg md:text-sm" href="#">
              Faqs
