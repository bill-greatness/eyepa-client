  ...
  return (
    ...
    >
      <div
        ...
        className="w-3/5 h-3/5 bg-white flex"
      >
        ...
        <div className="flex-1 flex flex-col space-y-3 py-10 pr-10">
          ...
          <div className="pt-5">
            <button  onClick={() => setAdd(food)} className="border text-sm font-medium border-yellow-400 bg-yellow-400 w-full p-4 rounded-md">
              Add to Cart
            </button>
          </div>
        </div>
