...
export default function Credential({next}) {
    return (
        <div className="flex  flex-col px-5 pt-10 md:w-1/4 space-y-4 text-sm md:p-5">
            ...
            <h3 className="text-2xl text-gray-600 font-medium leading-relaxed">What's your phone number or email ?</h3>

            <div className="w-full bg-gray-100 p-4 flex rounded-lg">
                <input className="bg-transparent flex-1" type="text" placeholder="Enter your phone number or email" />
            </div>

            <button onClick={next} className="bg-black text-white font-medium p-4 rounded-lg">
                Continue
            </button>
            ...
            <p className="text-gray-500 text-xs leading-relaxed text-center">By proceeding, you consent to get calls, WhatsApp or SMS messages, including by automated means, from Uber and its affiliates to the number provided.</p>
